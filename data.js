const parts = [
    [ // s1
        ...
        [ // p4
            ...
            [ // c5
                "*rumble*",
                "Mathcat: Yes, spymaster?",
                "Spymaster: There has been a disturbance in the code",
                "Some time ago...",
                "Sign: Welcome to JVM, population 5.5B",
                "<seggan standing in a room>",
                "<ginger begins to materialise>",
                "<ginger appears> Seggan: Hmm?",
                "Seggan: Ginger?",
                "Seggan: Back already?",
                "Ginger: Found something in Code Review's ruins that you might want",
                "<holds up diamond> Ginger: Slighty damaged, but still works™",
                "Ginger: Now, off to Kotlin Corp for more $$",
                "Seggan: cya",
                "<ginger disappears>",
                "<outside Kotlin Corp>",
                "<seggan appears>",
                "<seggan enters Kotlin Corp>",
                "Seggan: Brothers, we rule!",
                "<dennis standing in front of an audience> \nDennis: Friends, golfers, countrymen!",
                "Dennis: We're no strangers to code golf",
                "Dennis: You know the rules, and so do I. \nNP: SPAM! Person: Uh, Dennis?",
                "Dennis: There must always be a last in code golf",
                "Dennis: The coveted spot was always Java's. \nPerson: BOOO",
                "Dennis: Java has been taken over by Seggan",
                "Dennis: For Jelly's sake, we must free Java",
                "<A storm begins to brew around Kotlin Temple as Seggan goes mad with power>",
                "<JVM, sign: Billions of devices>",
                "<golfers in front of Kotlin Temple, Seggan standing above> \nPerson: I have a strange feeling of deja vu",
                "<person stabs someone, other person gets spam flagged, Dennis uses mod powers>",
                "Seggan: Fools! I can create endless legions of socks! \nDennis: We have to destroy his diamond! Steffan, take mine and destroy his! \nSteffan: Uh, if you insist...",
                "Dennis: Hey, doofus, look behind you! \nSeggan: You really think I'm falling for that? \nSteffan: No, really.",
                "Seggan: Aw, f-\n <SIGSEGV>",
                "<Kotlin Temple explodes>",
                "<SCHLORP>",
                "<Ginger, at Kotlin Corp, JVM in background>",
                "Person: Ginger.",
                "Person: I think you know why you're here",
                "Ginger: Look-",
                "Person: No.",
                "Person: 20k rep spent, for what?",
                "Ginger: We're working on it",
                "Ginger: Just give-\n <Kotlin Temple explodes in background>",
                "Person: ...",
                "Ginger: Oh no. \n Person: Well, that just happened.",
                "Ginger: I have to go. We can talk later. \n Person: But-",
                "<Ginger begins to disappear>",
                "<Ginger disappears>",
                "",
                "<Sʨɠɠan's combined diamond in the ruins of Kotlin Tower>",
                "<Ginger begins to materialise>",
                "Ginger: Oh, now this is interesting",
                "Person: Anyone there? \n Ginger: Time for me to go. Rabbit can wait.",
                "Person: Ginger? \n Ginger: Villain exits stage left",
                "Dennis: Ugh, they escaped. Fan out and search, that was a short-range teleport. \n Person: Aye \n Dennis: I'll go look for my diamond",
                "<mathcat watches from hillside as Kotlin Temple explodes>"
            ],
            [
                "Mathcat: What could they have stolen from my storage?",
                "Mathcat: Surely if they've resorted to raiding my most distant outpost, they're desperate",
                "Mathcat, to sock legion: It's time we go in for the kill",
                "Sʨɠɠan: They're at an abandoned bunker",
                "Sʨɠɠan: Cloudburst Gamma, a WWII chemical weapons facility. Horrible place",
                "<in bunker> \n Hyper: This place gives me the creeps. Do we really need to do it here of all places?",
                "Person: Yup. Only place we can get mathcat in range of the crystal that also has no background signature",
                "Lyxal: Do y'all have it in place?",
                "Person: Yep. Right under the air handler",
                "<outside the bunker> \n Bubbler: Do you think mathcat's picking up on the signal?",
                "Ginger: Absolutely. I'm thinking an army will show itself any minute.",
                "<battleship>",
                "Mathcat: We'll be landing shortly. Take a batallion of socks and flank right",
                "Sʨɠɠan: On it",
                "Hyper, looking out at battleship: They're here \n Person: Gotcha",
                "Mathcat, facing the bunker: You never stood a chance against my might",
                "Mathcat: On that ship, and lining up behind me, are 14,000 sockpuppets",
                "Mathcat: Why gloat though? Socks, kill.",
                "<Bubbler whacking socks with nun-chucks>",
                "<Person manning cannon>",
                "<Person stabbing sock> \n Sock: OUCH",
                "<Ginger using Perks to block socks>",
                "Bubbler: There's too many! Get in the bunker! \n Person: Fall back! Run!",
                "Sʨɠɠan, next to Mathcat: They ran in there!",
                "Mathcat: Socks, stay back. Sʨɠɠan, follow me.",
                "Mathcat, opposite TNB members: 1 on 1 huh?",
                "Mathcat: A brave way to go out \n Empty crystal begins to suck in power",
                "<Empty crystal sucks in power, removing Mathcat's staff powers>",
                "Mathcat: W-wait a minute",
                "Hyper: Our site did not take lightly to the voting fraud \n <Hyper takes away 1M rep from mathcat>",
                "Mathcat: Hyper...",
                "Ginger: Step aside y'all. Perks vs Nitro? I can win this all day",
                "Ginger: No staff power security blanket any more, Mathcat",
                "Mathcat, preparing shield: I'm sure we can work this out",
                "Mathcat: Divided kingdom? Do you want Stack Overflow?",
                "Ginger: Nobody wants Stack Overflow, bitch",
                "<Ginger launches a spell at Mathcat>",
                "<Ginger stabs mathcat>",
                "<THUD>",
                "Hyper: One year suspension!",
                "Ginger: You're too kind",
                "Sʨɠɠan: Now, take the hill, lads!",
                "<socks disappear> \n Sʨɠɠan: What am I doing here? \n Diamond uncracks",
                "Everyone: Woo! \n Ginger: Mathcat is vanquished! \n Seggan: I think I was in a coma \n Steffan: Same",
                "Bubbler: And Steffan, for having the courage to stop mathcat, back in the Bytecode, you deserve this",
                "Bubbler: Now fixed, an honorary mod diamond",
                "Steffan: Idk, just wouldn't feel right. Seggan, wanna go halvesies?",
                "Seggan: Sure!",
                "Seggan and Steffan, with half-diamonds: Wow, our minds are linked! This feels... familiar",
                "Seggan and Steffan: Sʨɠɠan forever!",
                "Ginger: After some long thought, I've decided",
